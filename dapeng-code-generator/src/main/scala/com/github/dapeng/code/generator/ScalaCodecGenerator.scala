...
class ScalaCodecGenerator extends CodeGenerator {
  ...
  def toSupperCodecTemplate(service:Service,structNamespaces:util.Set[String], oriNamespace: String): Elem = {
    return {
      <div>package {service.namespace.substring(0, service.namespace.lastIndexOf("."))}
        ...
        object {service.name}SupperCodec <block>
            //1.
        {
  ...
  def toCodecTemplate(service:Service,structNamespaces:util.Set[String], oriNamespace: String): Elem = {
    ...
    return {
      <div>package {service.namespace.substring(0, service.namespace.lastIndexOf("."))}
        ...
        *  @generated
        **/
        object {service.name}Codec extends {service.name}SupperCodec<block>
