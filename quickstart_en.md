...
<properties>
	...
	<dapeng.version>2.1.1</dapeng.version> <!-- 定义dapeng框架版本 -->
</properties>
...
# 指定参数运行
cd hello-service
mvn compile com.github.dapeng:dapeng-maven-plugin:2.1.1:run -Dsoa.apidoc.port=8089
```
...
dapengVersion [2.1.1]:    # dapeng框架的版本，现在是2.1.1
