...
public class SoaSystemEnvProperties {
     ...
     *  线上生产中k8s boot目录流量配置
     */
    private static final String KEY_SOA_BOOT_ENABLE="soa.boot.enable";


    public static final boolean SOA_BOOT_ENABLE=Boolean.valueOf(get(KEY_SOA_BOOT_ENABLE,"false" ));
