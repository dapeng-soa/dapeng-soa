 ...
 * @author ever
 */
public class testShmMutilDiff {
    private static final testShmMutilDiff instance = new testShmMutilDiff();
    /**
     * 自旋锁标志, 0为free
     */
    ...
    public static testShmMutilDiff getInstance() {
        return instance;
    }
    ...
    public static void process(){
        ...
        testShmMutilDiff manager = testShmMutilDiff.getInstance();
        ...
        t1 = System.nanoTime();
        for (int i = 0; i <500; i++) {
            result = manager.reportAndCheck(rule, 222);
        }
        ...
        t1 = System.nanoTime();
        for (int i = 0; i <500; i++) {
            result = manager.reportAndCheck(rule, 654);
        }
