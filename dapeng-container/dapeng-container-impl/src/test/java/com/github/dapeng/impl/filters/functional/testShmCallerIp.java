...
public class testShmCallerIp {
    private static final testShmCallerIp instance = new testShmCallerIp();
    /**
     * 自旋锁标志, 0为free
     */
    ...
    public static testShmCallerIp getInstance() {
        return instance;
    }
    ...
    public static void main(String[] args) {
        testShmCallerIp manager = testShmCallerIp.getInstance();
