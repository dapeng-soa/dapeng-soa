package com.github.dapeng.impl.filters.performance;
...
public class testShmPerformance {
    private static final testShmPerformance instance = new testShmPerformance();
    /**
     * 自旋锁标志, 0为free
     */
    ...
    public static testShmPerformance getInstance() {
        return instance;
    }
    ...
    public static void main(String[] args) {
        testShmPerformance manager = testShmPerformance.getInstance();
