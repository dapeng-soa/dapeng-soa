...
import com.github.dapeng.plugins.scheduler.listener.SchedulerJobListener;
import com.github.dapeng.plugins.scheduler.listener.SchedulerTriggerListener;
import org.quartz.*;
...
public class TaskSchedulePlugin implements AppListener, Plugin {
    ...
    public TaskSchedulePlugin(Container container) {
        ...
        if (scheduler == null) {
            try {
                ...
                LOGGER.error("com.github.dapeng.plugins.scheduler.TaskSchedulePlugin 初始化出错", e);
            }
        }
    }
    ...
    @Override
    public void stop() {
        LOGGER.warn("Plugin::com.github.dapeng.plugins.scheduler.TaskSchedulePlugin stop");
        try {
            if (scheduler != null) {
