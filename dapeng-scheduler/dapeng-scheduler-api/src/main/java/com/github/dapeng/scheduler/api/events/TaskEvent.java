package com.github.dapeng.scheduler.api.events;
 ...
 * DO NOT EDIT UNLESS YOU ARE SURE THAT YOU KNOW WHAT YOU ARE DOING
 ...
 SUCCEED = 1:执行成功 ;FAIL = 2:执行失败
            ...
            **/
            public com.github.dapeng.scheduler.api.enums.TaskStatusEnum taskStatus ;
            public com.github.dapeng.scheduler.api.enums.TaskStatusEnum getTaskStatus(){ return this.taskStatus; }
            public void setTaskStatus(com.github.dapeng.scheduler.api.enums.TaskStatusEnum taskStatus){ this.taskStatus = taskStatus; }

            public com.github.dapeng.scheduler.api.enums.TaskStatusEnum taskStatus(){ return this.taskStatus; }
            public TaskEvent taskStatus(com.github.dapeng.scheduler.api.enums.TaskStatusEnum taskStatus){ this.taskStatus = taskStatus; return this; }
 ...
 备注
        ...
        public static byte[] getBytesFromBean(TaskEvent bean) throws TException {
          ...
          new com.github.dapeng.scheduler.api.events.serializer.TaskEventSerializer().write(bean, protocol);
          transport.flush();
        ...
        public static TaskEvent getBeanFromBytes(byte[] bytes) throws TException {
          ...
          TCompactProtocol protocol = new TCompactProtocol(transport);
          return new com.github.dapeng.scheduler.api.events.serializer.TaskEventSerializer().read(protocol);
        }
