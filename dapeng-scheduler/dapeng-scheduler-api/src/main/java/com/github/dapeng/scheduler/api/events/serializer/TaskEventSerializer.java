 package com.github.dapeng.scheduler.api.events.serializer;
        ...
        *
        **/
        public class TaskEventSerializer implements BeanSerializer<com.github.dapeng.scheduler.api.events.TaskEvent>{
        
      @Override
      public com.github.dapeng.scheduler.api.events.TaskEvent read(TProtocol iprot) throws TException{

      com.github.dapeng.scheduler.api.events.TaskEvent bean = new com.github.dapeng.scheduler.api.events.TaskEvent();
      ...
      while(true){
       ...
       bean.setCostTime(elem0);
              ...
              com.github.dapeng.scheduler.api.enums.TaskStatusEnum elem0 = com.github.dapeng.scheduler.api.enums.TaskStatusEnum.findByValue(iprot.readI32());
      ...
      @Override
      public void write(com.github.dapeng.scheduler.api.events.TaskEvent bean, TProtocol oprot) throws TException{
      ...
      oprot.writeStructBegin(new com.github.dapeng.org.apache.thrift.protocol.TStruct("TaskEvent"));
            ...
            com.github.dapeng.scheduler.api.enums.TaskStatusEnum elem5 = bean.getTaskStatus();
      ...
      public void validate(com.github.dapeng.scheduler.api.events.TaskEvent bean) throws TException{
        ...
        @Override
        public String toString(com.github.dapeng.scheduler.api.events.TaskEvent bean)
