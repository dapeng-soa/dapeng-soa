 package com.github.dapeng.soa.scala.info.serializer
...
import com.github.dapeng.soa.scala.info.serializer._;
        ...
        **/
        ...
        class InfoSerializer extends BeanSerializer[com.github.dapeng.soa.scala.info.Info]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.github.dapeng.soa.scala.info.Info = {
      ...
      val bean = com.github.dapeng.soa.scala.info.Info(name = name,code = code)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.github.dapeng.soa.scala.info.Info, oprot: TProtocol): Unit = {
      ...
      @throws[TException]
      override def validate(bean: com.github.dapeng.soa.scala.info.Info): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.github.dapeng.soa.scala.info.Info): String = if (bean == null) "null" else bean.toString
