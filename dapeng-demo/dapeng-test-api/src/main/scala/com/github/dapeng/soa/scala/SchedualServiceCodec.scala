package com.github.dapeng.soa.scala
      ...
      override def validate(bean: test_result): Unit = {
            ...
            class test extends SoaFunctionDefinition.Sync[com.github.dapeng.soa.scala.service.SchedualService, test_args, test_result]("test", new Test_argsSerializer(), new Test_resultSerializer()){

            @throws[TException]
            def apply(iface: com.github.dapeng.soa.scala.service.SchedualService, args: test_args):test_result = {
  ...
  class getServiceMetadata extends SoaFunctionDefinition.Sync[com.github.dapeng.soa.scala.service.SchedualService, getServiceMetadata_args, getServiceMetadata_result](
  "getServiceMetadata", new GetServiceMetadata_argsSerializer(), new GetServiceMetadata_resultSerializer()) {


      @throws[TException]
      override def apply(iface: com.github.dapeng.soa.scala.service.SchedualService, args: getServiceMetadata_args): getServiceMetadata_result = {

              val source = scala.io.Source.fromInputStream(SchedualServiceCodec.getClass.getClassLoader.getResourceAsStream("com.github.dapeng.soa.service.SchedualService.xml"))
      ...
      class Processor(iface: com.github.dapeng.soa.scala.service.SchedualService, ifaceClass: Class[com.github.dapeng.soa.scala.service.SchedualService] ) extends
        SoaServiceDefinition(iface,classOf[com.github.dapeng.soa.scala.service.SchedualService], Processor.getProcessMap)

        object Processor{

          type PF = SoaFunctionDefinition[com.github.dapeng.soa.scala.service.SchedualService, _, _]
