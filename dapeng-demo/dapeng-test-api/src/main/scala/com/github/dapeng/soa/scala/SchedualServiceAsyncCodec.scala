package com.github.dapeng.soa.scala
      ...
      override def validate(bean: test_result): Unit = {
            ...
            def apply(iface: com.github.dapeng.soa.scala.service.SchedualServiceAsync, args: test_args):Future[test_result] = {
              ...
              val _result = iface.test(50000)

              _result.map(test_result(_)).tojava
        ...
        class Processor(iface: com.github.dapeng.soa.scala.service.SchedualServiceAsync, ifaceClass: Class[com.github.dapeng.soa.scala.service.SchedualServiceAsync]) extends
