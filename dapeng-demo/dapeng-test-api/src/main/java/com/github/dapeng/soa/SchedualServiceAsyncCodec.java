package com.github.dapeng.soa;
      ...
      public void validate(test_result bean) throws TException{
            ...
            public static class test<I extends com.github.dapeng.soa.service.SchedualServiceAsync> extends SoaFunctionDefinition.Async<I, test_args, test_result>
            {
              public test()
              {
        ...
        public static class getServiceMetadata<I extends com.github.dapeng.soa.service.SchedualServiceAsync> extends SoaFunctionDefinition.Async<I, getServiceMetadata_args, getServiceMetadata_result> {
        ...
        public static class Processor<I extends com.github.dapeng.soa.service.SchedualServiceAsync> extends SoaServiceDefinition<com.github.dapeng.soa.service.SchedualServiceAsync>
        {

          public Processor(com.github.dapeng.soa.service.SchedualServiceAsync iface, Class<com.github.dapeng.soa.service.SchedualServiceAsync> ifaceClass)
          {
            super(iface, ifaceClass, buildMap(new java.util.HashMap<>()));
          }

          @SuppressWarnings("unchecked")
          private static <I extends com.github.dapeng.soa.service.SchedualServiceAsync> java.util.Map<String, SoaFunctionDefinition<I, ?, ?>> buildMap(java.util.Map<String, SoaFunctionDefinition<I, ?, ?>> processMap)
          {
