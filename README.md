...
>
> 输出的可执行jar包目录: `dapeng-code-generator/target/dapeng-code-generator-2.0.4-jar-with-dependencies.jar`

打印帮助命令

```
java -jar dapeng-code-generator-2.0.4-jar-with-dependencies.jar
...
```
java -jar dapeng-code-generator-2.0.4-jar-with-dependencies.jar -gen java -out F:\hello F:\hello\hello_domain.thrift,F:\hello\hello_service.thrift
...
# 第二种
cd hello-service
mvn compile com.github.dapeng:dapeng-maven-plugin:2.0.4:run -Dsoa.remoting.mode=local
```
...
# 第二种
cd hello-service
mvn compile com.github.dapeng:dapeng-maven-plugin:2.0.4:run
```
