package com.github.dapeng.eventbus.api.message;
        ...
        **/
        public class MsgScheduledServiceAsyncCodec {
      ...
      public void validate(fetchMessage_result bean) throws TException{
            ...
            public static class fetchMessage<I extends com.github.dapeng.eventbus.api.message.service.MsgScheduledServiceAsync> extends SoaFunctionDefinition.Async<I, fetchMessage_args, fetchMessage_result>
            {
              public fetchMessage()
              {
              ...
              @Override
              public CompletableFuture<fetchMessage_result> apply(MsgScheduledServiceAsync iface, fetchMessage_args fetchMessage_args) throws SoaException
              {

                CompletableFuture<Void> result = (CompletableFuture<Void>) iface.fetchMessage();

                return result.thenApply((Void) -> {
                  fetchMessage_result res = new fetchMessage_result();
        ...
        public static class getServiceMetadata<I extends com.github.dapeng.eventbus.api.message.service.MsgScheduledServiceAsync> extends SoaFunctionDefinition.Async<I, getServiceMetadata_args, getServiceMetadata_result> {
        ...
        public static class Processor<I extends com.github.dapeng.eventbus.api.message.service.MsgScheduledServiceAsync> extends SoaServiceDefinition<com.github.dapeng.eventbus.api.message.service.MsgScheduledServiceAsync>
        {

          public Processor(com.github.dapeng.eventbus.api.message.service.MsgScheduledServiceAsync iface, Class<com.github.dapeng.eventbus.api.message.service.MsgScheduledServiceAsync> ifaceClass)
          {
            super(iface, ifaceClass, buildMap(new java.util.HashMap<>()));
          }

          @SuppressWarnings("unchecked")
          private static <I extends com.github.dapeng.eventbus.api.message.service.MsgScheduledServiceAsync> java.util.Map<String, SoaFunctionDefinition<I, ?, ?>> buildMap(java.util.Map<String, SoaFunctionDefinition<I, ?, ?>> processMap)
          {
