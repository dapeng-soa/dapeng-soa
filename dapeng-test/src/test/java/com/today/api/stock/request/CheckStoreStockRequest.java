 ...
 * DO NOT EDIT UNLESS YOU ARE SURE THAT YOU KNOW WHAT YOU ARE DOING
        ...
        *
        **/
        public class CheckStoreStockRequest{
 ...
 门店财务 ID
            ...
            **/
            ...
            public CheckStoreStockRequest storeId(String storeId){ this.storeId = storeId; return this; }
 ...
 货号集合
            ...
            **/
            ...
            public CheckStoreStockRequest skuNos(java.util.List<String> skuNos){ this.skuNos = skuNos; return this; }
          

        public static byte[] getBytesFromBean(CheckStoreStockRequest bean) throws TException {
          byte[] bytes = new byte[]{};
          TCommonTransport transport = new TCommonTransport(bytes, TCommonTransport.Type.Write);
          TCompactProtocol protocol = new TCompactProtocol(transport);

          new com.today.api.stock.request.serializer.CheckStoreStockRequestSerializer().write(bean, protocol);
          transport.flush();
          return transport.getByteBuf();
        }

        public static CheckStoreStockRequest getBeanFromBytes(byte[] bytes) throws TException {
          TCommonTransport transport = new TCommonTransport(bytes, TCommonTransport.Type.Read);
          TCompactProtocol protocol = new TCompactProtocol(transport);
          return new com.today.api.stock.request.serializer.CheckStoreStockRequestSerializer().read(protocol);
        }
