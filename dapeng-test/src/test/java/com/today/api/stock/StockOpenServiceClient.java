...
package com.today.api.stock;
      ...
      import com.today.api.stock.StockOpenServiceCodec.*;
      import com.today.api.stock.StockOpenServiceSuperCodec.*;
      import com.today.api.stock.service.StockOpenService;
 ...
 * DO NOT EDIT UNLESS YOU ARE SURE THAT YOU KNOW WHAT YOU ARE DOING
      ...
      **/
      public class StockOpenServiceClient implements StockOpenService{
      ...
      public StockOpenServiceClient(String serviceVersion) {
        this.serviceName = "com.today.api.stock.service.StockOpenService";
...
## 输出
        1.
            ...
            **/
              ...
              public java.util.List<com.today.api.stock.response.GetStoreStockResponse> getStoreStock(com.today.api.stock.request.GetStoreStockRequest request) throws SoaException{
              ...
              getStoreStock_result response = pool.send(serviceName,version,"getStoreStock",getStoreStock_args, new GetStoreStock_argsSerializer(), new GetStoreStock_resultSerializer());
...
## 输出
        1.
            ...
            **/
              ...
              public java.util.List<com.today.api.stock.response.CheckStoreStockResponse> checkStoreStock(com.today.api.stock.request.CheckStoreStockRequest request) throws SoaException{
              ...
              checkStoreStock_result response = pool.send(serviceName,version,"checkStoreStock",checkStoreStock_args, new CheckStoreStock_argsSerializer(), new CheckStoreStock_resultSerializer());
...
## 输出
        1.
            ...
            **/
              ...
              public com.today.api.stock.response.DeductStockByAppResponse deductStockByApp(com.today.api.stock.request.DeductStockByAppRequest request) throws SoaException{
              ...
              deductStockByApp_result response = pool.send(serviceName,version,"deductStockByApp",deductStockByApp_args, new DeductStockByApp_argsSerializer(), new DeductStockByApp_resultSerializer());
...
## 输出
        1.
            ...
            **/
              ...
              public com.today.api.stock.response.AddStockByAppReturnResponse addStockByAppReturn(com.today.api.stock.request.AddStockByAppReturnRequest request) throws SoaException{
              ...
              addStockByAppReturn_result response = pool.send(serviceName,version,"addStockByAppReturn",addStockByAppReturn_args, new AddStockByAppReturn_argsSerializer(), new AddStockByAppReturn_resultSerializer());
