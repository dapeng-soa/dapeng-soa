 ...
 * DO NOT EDIT UNLESS YOU ARE SURE THAT YOU KNOW WHAT YOU ARE DOING
        ...
        *
        **/
        public class GetStoreStockResponse{
 ...
 货号
            ...
            **/
            ...
            public GetStoreStockResponse skuNo(String skuNo){ this.skuNo = skuNo; return this; }
...
//
            ...
            **/
            ...
            public GetStoreStockResponse stockNum(int stockNum){ this.stockNum = stockNum; return this; }
          

        public static byte[] getBytesFromBean(GetStoreStockResponse bean) throws TException {
          byte[] bytes = new byte[]{};
          TCommonTransport transport = new TCommonTransport(bytes, TCommonTransport.Type.Write);
          TCompactProtocol protocol = new TCompactProtocol(transport);

          new com.today.api.stock.response.serializer.GetStoreStockResponseSerializer().write(bean, protocol);
          transport.flush();
          return transport.getByteBuf();
        }

        public static GetStoreStockResponse getBeanFromBytes(byte[] bytes) throws TException {
          TCommonTransport transport = new TCommonTransport(bytes, TCommonTransport.Type.Read);
          TCompactProtocol protocol = new TCompactProtocol(transport);
          return new com.today.api.stock.response.serializer.GetStoreStockResponseSerializer().read(protocol);
        }
