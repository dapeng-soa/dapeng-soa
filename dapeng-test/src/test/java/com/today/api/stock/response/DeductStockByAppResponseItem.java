 ...
 * DO NOT EDIT UNLESS YOU ARE SURE THAT YOU KNOW WHAT YOU ARE DOING
        ...
        *
        **/
        public class DeductStockByAppResponseItem{
 ...
 货号
            ...
            **/
            ...
            public DeductStockByAppResponseItem skuNo(String skuNo){ this.skuNo = skuNo; return this; }
          
            /**
            *

 扣减之后的实时库存数量, 如果扣减不成功则返回当前库存数量
            ...
            **/
            ...
            public DeductStockByAppResponseItem currentStockNum(int currentStockNum){ this.currentStockNum = currentStockNum; return this; }
 ...
 是否是安全库存 当前库存大于常量 SAFETY_STOCK_NUM = 3 个定义为安全库存
            ...
            **/
            ...
            public DeductStockByAppResponseItem hasSafetyStock(boolean hasSafetyStock){ this.hasSafetyStock = hasSafetyStock; return this; }
          

        public static byte[] getBytesFromBean(DeductStockByAppResponseItem bean) throws TException {
          byte[] bytes = new byte[]{};
          TCommonTransport transport = new TCommonTransport(bytes, TCommonTransport.Type.Write);
          TCompactProtocol protocol = new TCompactProtocol(transport);

          new com.today.api.stock.response.serializer.DeductStockByAppResponseItemSerializer().write(bean, protocol);
          transport.flush();
          return transport.getByteBuf();
        }

        public static DeductStockByAppResponseItem getBeanFromBytes(byte[] bytes) throws TException {
          TCommonTransport transport = new TCommonTransport(bytes, TCommonTransport.Type.Read);
          TCompactProtocol protocol = new TCompactProtocol(transport);
          return new com.today.api.stock.response.serializer.DeductStockByAppResponseItemSerializer().read(protocol);
        }
