 ...
 * DO NOT EDIT UNLESS YOU ARE SURE THAT YOU KNOW WHAT YOU ARE DOING
        ...
        *
        **/
        public class DeductStockByAppRequestItem{
 ...
 skuNo
            ...
            **/
            ...
            public DeductStockByAppRequestItem skuNo(String skuNo){ this.skuNo = skuNo; return this; }
 ...
 库存来源 id, 订单= order_detail.id
            ...
            **/
            ...
            public DeductStockByAppRequestItem sourceId(long sourceId){ this.sourceId = sourceId; return this; }
 ...
 库存来源时间, 订单= 订单创建时间
            ...
            **/
            ...
            public DeductStockByAppRequestItem sourceTime(long sourceTime){ this.sourceTime = sourceTime; return this; }
 ...
 库存发生数(正数)
            ...
            **/
            ...
            public DeductStockByAppRequestItem stockNum(int stockNum){ this.stockNum = stockNum; return this; }
          

        public static byte[] getBytesFromBean(DeductStockByAppRequestItem bean) throws TException {
          byte[] bytes = new byte[]{};
          TCommonTransport transport = new TCommonTransport(bytes, TCommonTransport.Type.Write);
          TCompactProtocol protocol = new TCompactProtocol(transport);

          new com.today.api.stock.request.serializer.DeductStockByAppRequestItemSerializer().write(bean, protocol);
          transport.flush();
          return transport.getByteBuf();
        }

        public static DeductStockByAppRequestItem getBeanFromBytes(byte[] bytes) throws TException {
          TCommonTransport transport = new TCommonTransport(bytes, TCommonTransport.Type.Read);
          TCompactProtocol protocol = new TCompactProtocol(transport);
          return new com.today.api.stock.request.serializer.DeductStockByAppRequestItemSerializer().read(protocol);
        }
